...
function AppContent() {
  const { data, isLoading, updateProfile } = useBukuKas();
  ...
  useEffect(() => {
    if (!isLoading && data.profile.name === 'Toko Kelontong Saya' && !data.profile.phone) {
              ...
              <form onSubmit={handleOnboardingSubmit} className="bg-white text-slate-800 p-5 rounded-3xl space-y-4 shadow-xl border border-slate-100">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold focus:outline-none focus:border-indigo-500 focus:bg-white"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold focus:outline-none focus:border-indigo-500 focus:bg-white"
                      required
                    />
                  </div>
                </div>
